...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    ...
    "			<button class=\"btn btn-small btn-inverse\" ng-click=\"today()\">Hoy</button>\n" +    
    "			<button class=\"btn btn-small btn-danger\" ng-click=\"clear()\">Borrar</button>\n" +
    "		</span>\n" +
    "		<button class=\"btn btn-small btn-success pull-right\" ng-click=\"isOpen = false\">Cerrar</button>\n" +
    "	</li>\n" +
    "</ul>");
}]);
