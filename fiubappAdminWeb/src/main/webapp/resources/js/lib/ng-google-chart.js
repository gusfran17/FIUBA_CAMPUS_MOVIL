            ...
            return {
                ...
                link: function(scope, element, attrs, googleChartController){
                    ...
                    function callback(chartWrapper){
                    	...
                    	if(chartWrapper.getChartType() == 'LineChart')
                        	scope.chartWrapperLinea = chartWrapper;                        
                        else if(chartWrapper.getChartType() == 'PieChart')
                        	scope.chartWrapperTorta = chartWrapper;
                        else if(chartWrapper.getChartType() == 'ColumnChart')
                        	scope.chartWrapperBarra = chartWrapper;
